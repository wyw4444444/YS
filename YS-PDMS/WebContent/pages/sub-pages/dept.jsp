		...
		<div class="form-inline">
			<div class="form-group">
				<shiro:hasAnyRoles name="super_admin,admin">
					<button class="btn btn-primary" onclick="showModalDept()">新增部门</button>&nbsp;
				</shiro:hasAnyRoles>
				<button class="btn btn-secondary" onclick="loadDept('1')">有效部门</button>&nbsp;
				<button class="btn btn-secondary" onclick="loadDept('2')">所有部门</button>&nbsp;
			</div>
			<div class="form-group">
				<div class="input-group">
					<select class="form-control" id="deptSearchTypeList">
						<option value="undefined">查询内容</option>
						<option value="dept_code">部门代号</option>
